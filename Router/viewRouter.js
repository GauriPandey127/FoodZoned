...
const { getHomePage, getLoginPage, getSignUpPage, getPlansPage , getResetPasswordPage  , getProfilePage, getReviewsPage, getCheckoutPage} = require("../Controller/viewController");
...
viewRouter.route("/checkout/:id").get(getCheckoutPage);
